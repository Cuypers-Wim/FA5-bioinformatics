...
=======
## Making a Phylogenetic Tree from WGS Data
>>>>>>> f78673bb5d3a5cedb0b1fb61fa33e18eff10cecd
...
<<<<<<< HEAD
One option is to use the python script that we used during the course. You can find it here: [https://github.com/FreBio/mytools/blob/master/vcf2fasta.py](https://github.com/FreBio/mytools/blob/master/vcf2fasta.py) . You can use on your combined VCF files produced with GATK.
