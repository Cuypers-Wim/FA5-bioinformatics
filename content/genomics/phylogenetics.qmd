...
When you made a pipeline for Plamsodium or other parasites, you will likely have run BWA and GATK. There are multiple methods to combine your data into a format that can be used by phylogenetic tree building programs.

Here’s your course section rewritten in Quarto markdown:


### Option 2: Run `snippy Core`

If your project involves bacteria or viruses, you may have used `snippy` to analyze your FASTQ files. The command might have looked something like this:
