...
2. Count the number of chromosomes in the _P. falciparum_ reference genome fasta file (`plasmodium_falciparum_3D7.fasta`).
...
7. Extract the header information from `ampliseq-variants.vcf` (you can find this file in the `unix-demo` directory), sort it alphabetically, and store it in a file named `vcf-header.txt`.
